// Allow dead code from forked implementation - not all features are implemented yet
#![allow(dead_code)]

use std::{fmt, io::Cursor, net::SocketAddr, num::TryFromIntError, string::FromUtf8Error};

// Re-export for internal use - modern Rust doesn't need #[macro_use] extern crate
